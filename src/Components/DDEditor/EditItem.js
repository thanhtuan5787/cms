        ...
        <>
            ...
            {mode == 'edit' ? (
                ...
                <LinkWrapper link={elemData.href}>
                    <Rect ref={divRef} elemData={elemData}>{props.children}</Rect>
                </LinkWrapper>
            )}
        </>
    );
...
const Rect = React.forwardRef((props, ref) => {
    ...
    const childrenProps = Object.assign({}, props);
    delete childrenProps.elemData;
    delete childrenProps.onMouseDownDrag;
    delete childrenProps.onMouseDownRes;
    delete childrenProps.onMouseDownRot;
